...
$fileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));
     ...
     $errors1='';
      ...
      if($errors==0){
         move_uploaded_file($file_tmp,"alimages/".$file_name);
...
if ($conn->connect_error) {
  ...
  $sql = "insert into alumini(name, desg, ld, fb, tw, image) VALUES ('".$names."','".$des."','".$lid."','".$fbook."','".$tm."','".$file_name."')";
mysqli_query($conn,$sql);

                mysqli_close($conn);
          header("Location: asuccess.html");
exit;
