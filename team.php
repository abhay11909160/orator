...
.heading
{
    ...
    font-size: 22px;
    margin-bottom: 30px;
    border: 1px solid #8e17ff;
    box-shadow: inset -12px -12px 24px rgb(255 255 255 / 80%), inset 12px 12px 24px rgb(0 6 39 / 10%);
}
...
.ab:hover{
color: #f7b42c;
color: linear-gradient(315deg, #f7b42c 0%, #fc575e 74%);
}
...
<section class="mainbg">
 ...
 <a href="index.php" class="btw"><i class="fa fa-arrow-left"></i></a>
    ...
    <div class="row">
      ...
      <?php include 'admin/php/member/madd.php';?>
